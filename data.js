// data.js — datasets + TTS preference (male, en-US).
...
// ===== TTS preference (male en-US) =====
// common.js should read this to pick voices.
export const TTS_PREF = {
  lang: 'en-US',
  preferMale: true,
  // Try voices in this order if available on the device:
  preferredNames: [
    // Apple (iOS/macOS)
    'Aaron', 'Alex', 'Tom',
...
// Attach to window for non-module usage too (optional)
if (typeof window !== 'undefined') {
  window.APP_DATA = { vocab, stopWords, opsWords, inspectWords, maintWords, dialogs, states };
  window.TTS_PREF = TTS_PREF;
}
